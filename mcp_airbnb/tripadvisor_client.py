...
from config import TRIPADVISOR_CONFIG, EMOJIS, MESSAGES


class TripAdvisorMCPClient:
    """
    ...
    def start_server(self) -> bool:
        ...
        """
        print(f"{EMOJIS['start']} {MESSAGES['starting_tripadvisor_server']}")
        
        if not self.api_key or "YOUR_API_KEY" in self.api_key:
            print(f"{EMOJIS['error']} {MESSAGES['tripadvisor_api_key_missing']}")
            return False
        ...
        try:
            ...
            print(f"{EMOJIS['error']} {MESSAGES['tripadvisor_server_error'].format(error=e)}")
            return False
    ...
    def search_locations(self, search_query: str, category: str = None) -> List[Dict]:
        ...
        """
        print(f"{EMOJIS['search']} {MESSAGES['searching_tripadvisor'].format(query=search_query)}")
    ...
    def stop_server(self):
        ...
        if self.process:
            ...
            print(f"{EMOJIS['stop']} {MESSAGES['tripadvisor_server_stopped']}")
            self.process = None