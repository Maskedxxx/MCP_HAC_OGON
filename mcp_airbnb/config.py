...
MESSAGES = {
    ...
    # Сообщения для TripAdvisor
    "starting_tripadvisor_server": "Запускаю TripAdvisor MCP сервер...",
    "tripadvisor_server_stopped": "TripAdvisor сервер остановлен",
    "tripadvisor_api_key_missing": "Не указан API ключ TripAdvisor",
    "tripadvisor_server_error": "Ошибка запуска TripAdvisor сервера: {error}",
    "searching_tripadvisor": "Ищу в TripAdvisor: {query}...",
